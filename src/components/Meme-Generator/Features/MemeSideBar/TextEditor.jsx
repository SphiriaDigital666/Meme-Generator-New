...
const TextEditor = ({
  ...
  return (
    <div className="flex flex-row sm:inline-block">
      <div className="sm:mb-4 h-auto mr-2 sm:mr-0">
        <input
          type="text"
          value={text.text || ""}
          className="w-full rounded-lg h-full bg-[#212025] px-2 py-1.5 text-white sm:text-[14px] lg:text-[15px] 2xl:py-2 2xl:text-[16px]"
      ...
      <div className="">
        <div className="mb-4 flex items-center gap-4 text-white justify-end">
          <button
            onClick={onAddText}
            disabled={isAddDisabled}
            className="flex  w-[70px] sm:w-[100px] items-center justify-center gap-1 rounded-md bg-[#50ECC6] px-2 py-1 sm:text-[14px] lg:text-[15px] 2xl:text-[16px]"
          >
            {/* <MdAddToPhotos className="text-[16px] text-[#16151A] 2xl:text-[18px]" /> */}
            <p className="font-normal sm:font-semibold text-[#16151A]"> Add</p>
          </button>
          <button
            onClick={onDeleteText}
            className="flex  w-[70px] sm:w-[100px] items-center justify-center gap-0.5 rounded-md bg-[#EC917D] px-2 py-1 sm:text-[14px] lg:text-[15px] 2xl:text-[16px]"
          >
            {/* <MdDeleteForever className="-translate-y-[1px] text-[16px] text-[#16151A] 2xl:text-[18px]" /> */}
            <p className="font-normal sm:font-semibold text-[#16151A]"> Delete</p>
          </button>
        </div>
        ...
        <div className="flex gap-1 text-white justify-between">
          ...
          >
            <div className=" px-2 sm:px-6 py-1">
